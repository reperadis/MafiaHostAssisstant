...
public partial class OP_IntegerOperation : Operation
{
	...
	protected override void OnAddition(BehaviorEditor behaviorEditor)
	{
		...
		assignToVariableHandler = new(behaviorEditor, this, Tr("TK:OP_FIELD_WRITE-TO"), BehaviorVariableType.Integer, assignToVarNameLabel, assignToVarTypeTextureRect);
	...
	{
		return new OperationReference(OperationName.IntegerOperation, new Arguments(leftVariableHandler.Variable.TrueVariableName, rightVariableHandler.Variable.TrueVariableName, assignToVariableHandler.Variable.TrueVariableName, operationType));
	}

	public override string GetReadableOpearationName()
	{
		return Tr("TK:OP_INTEGER-OPERATION");
	}
